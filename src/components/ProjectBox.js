            ...
            {index % 2 === 0 ?
                <>
                    <div className="projectGallery">
                        ...
                        <button type="button" className="absolute top-0 left-0 z-15 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={(e) => pictureChange(e, "left")} data-direction='prev'>
                        ...
                        <button type="button" className="absolute top-0 right-0 z-15 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={(e) => pictureChange(e, "right")} data-direction='next'>
                            <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
